...
const getAllModules = async (directory, { excludeList = [], fileMode = false }) => {
    ...
    try {
        ...
        for (const file of fileList) {
            ...
            importedModules[path.basename(file.name)] = Promise.resolve().then(() => __importStar(require(`${directory}/${file.name}`)));
        }
    }
    catch (error) {
    }
